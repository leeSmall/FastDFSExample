...
public class FastDFSClient {
	 ...
	 * @param fileName
	 *            例如"M00/00/00/wKiYglnKy5WAGCE5AAAADCC3yYc463.txt"
	 ...
	 * 
	 * @param fileId file_id源码中的解释file_id the file id(including group name and filename);例如 group1/M00/00/00/wKiYglnKy5WAGCE5AAAADCC3yYc463.txt
	 * @return 0为成功，非0为失败，具体为错误代码
	 */
	 ...
	 * 修改一个已经存在的文件
	 * 
	 * @param oldFileId 原来旧文件的fileId, file_id源码中的解释file_id the file id(including group name and filename);例如 group1/M00/00/00/wKiYglnKy5WAGCE5AAAADCC3yYc463.txt
	 * @param file 新文件
